...
| OperationalAuthorities  | Список uid полномочий через `!` (energy.xml — массив блоков operationalAuthority) |
| electrical_safety_level | UID уровня электробезопасности (опционально, energy.xml — ElectricalSafetyLevel)  |
...
| name                             | login          | email        | mobilePhone | position                             | OperationalAuthorities                                                    | electrical_safety_level              | person_guid                          | parent_energy                        | parent_sysconfig                     |
| -------------------------------- | -------------- | ------------ | ----------- | ------------------------------------ | ------------------------------------------------------------------------- | ------------------------------------ | ------------------------------------ | ------------------------------------ | ------------------------------------ |
...
| Алексенцев Александр Геннадьевич | Sokolov.Sni    | asni@mail.ru | 9215050011  |                                      |                                                                           | 62c05a53-0b27-4a62-b958-c24840a13c30 | 62c05a53-0b27-4a62-b958-c24840a13c30 | f0eb1cfb-7939-46e2-b36a-ba316b109a56 | 74f289ae-0eb9-4341-8912-8e211f4c01f9 |
| Михайлова Анна Сергеевна         | Mikhaylova.Ase |              |             |                                      |                                                                           |                                      |                                      | f0eb1cfb-7939-46e2-b36a-ba316b109a56 | 74f289ae-0eb9-4341-8912-8e211f4c01f9 |

*Поля email, mobilePhone, position, OperationalAuthorities, electrical_safety_level могут быть опущены или оставаться пустыми — в этом случае соответствующие XML-блоки отсутствуют.*
...
5. При отрицательном — введите GUID домена (adGuid), когда появится запрос.
