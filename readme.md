...
3.1. При положительном ответе данные будут скопированы из домена
3.2. При отрицательном ответе необходимо ввести GUID домена (adGuid), когда появится запрос.
